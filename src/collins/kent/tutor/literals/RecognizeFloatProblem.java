...
@Skill(skill="Recognize literals of type float")
public class RecognizeFloatProblem implements Problem, NumericExpression {

	private String displayString;

	@Override
	public RecognizeFloatProblem generate(Random rng) {
